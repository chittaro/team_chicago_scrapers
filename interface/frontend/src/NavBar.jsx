...
function NavBar() {
  ...
  return (
    <nav style={{position: 'sticky', top: 0, backgroundColor: '#f0f0f0', display: 'flex',
        ...
        <button onClick={() => navigate('/company/autodesk')} style={{ flex: 1, borderRight: '1px solid #ccc' }}>Autodesk</button>
        <button onClick={() => navigate('/company/faro')} style={{ flex: 1, borderRight: '1px solid #ccc' }}>Faro</button>
